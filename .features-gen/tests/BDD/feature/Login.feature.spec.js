...
test.describe('Perform Login Validations', () => {
  ...
  test.describe('', () => {
    ...
    test('Example #1', async ({ Then, page }) => { 
      await Then('User verifies the "Phone" option visibility', null, { page }); 
      await Then('User gets total "Phone" count', null, { page }); 
      await Then('User logs out', null, { page }); 
    });

    test('Example #2', async ({ Then, page }) => { 
      await Then('User verifies the "Laptop" option visibility', null, { page }); 
      await Then('User gets total "Laptop" count', null, { page }); 
      await Then('User logs out', null, { page }); 
    });
